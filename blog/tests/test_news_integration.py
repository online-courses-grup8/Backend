"""
Test Case #272 / Task #272 - News module integration tests
Azure DevOps Work Item: https://dev.azure.com/grup8devops/Online_Course/_workitems/edit/272

Goal:
Verify the news/blog module integration between the model, selector, serializer,
pagination, and public list API endpoint.

Flow:
1. Create published and unpublished news records in the test database
2. Request the public news list endpoint
3. Verify only published news records are returned
...
class NewsModuleIntegrationTest(APITestCase):
    def setUp(self):
        ...
        *,
        ...
        post = BlogPost.objects.create(
            ...
            content=(
                ...
                "testing of the news module API response."
            ),
            thumbnail=thumbnail,
            category="Education",
